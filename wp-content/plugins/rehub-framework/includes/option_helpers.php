...
function rehub_get_post_layout_array()
{
	$postlayout = apply_filters( 'rehub_post_layout_array', array(
		...
		array(
			...
			'label' => esc_html__('Full width, optimized for reading', 'rehub-framework'),
		),			
		array(
			'value' => 'meta_compact',
	...
	if (defined('\ContentEgg\PLUGIN_PATH')){
		$postlayoutce = array(
			array(
				...
				'label' => esc_html__('Price comparison (compact)', 'rehub-framework'),
			),			
			array(
				'value' => 'meta_ce_compare_full',
				'label' => esc_html__('Price comparison (Full width)', 'rehub-framework'),
			),		
			array(
				'value' => 'meta_ce_compare_auto_sec',
				'label' => esc_html__('Auto content Content Egg', 'rehub-framework'),
			),				
		);
