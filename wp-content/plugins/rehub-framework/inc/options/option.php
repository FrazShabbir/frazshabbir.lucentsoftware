					...
					'fields' => array(						
						array(
							...
							'items' => array(
								...
								array(
									'value' => 'header_clean',
									'label' => esc_html__('Clean code zone', 'rehub-framework'),
								),																				
							),
								'default' => array(
								'header_seven',
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'label' => esc_html__('Enable affiliate links from title and image in grid?', 'rehub-framework'),		
							'default' => 0,							
						),																		
						array(
							'type' => 'toggle',
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'label' => esc_html__('Enable lazyload script on thumbnails for better image perfomance. Sometimes can be buggy with other scripts', 'rehub-framework'),
							'default' => '1',
						),											
						array(
							'type' => 'toggle',
							'name' => 'repick_social_disable',
							'label' => esc_html__('Disable social buttons on images', 'rehub-framework'),
							'description' => esc_html__('Enable/Disable buttons in grid loop', 'rehub-framework'),
							'default' => '0',
						),											
						array(
							'type' => 'toggle',
