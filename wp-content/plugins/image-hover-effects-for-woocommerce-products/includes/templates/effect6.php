<?php if ( $wdo_product['animation_direction']=='left_to_right' || $wdo_product['animation_direction']=='right_to_left' ){
		$wdo_product['animation_direction'] = 'from_left_and_right';
	} 
	
?>

<?php $woo_product = wc_get_product(); ?>
<div class="woo-hover-item square effect6 <?php echo $wdo_product['animation_direction']; ?>">
