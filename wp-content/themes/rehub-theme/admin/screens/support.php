...
<div class="wrap about-wrap rehub-wrap">
    ...
    <div class="rehub-important-notice">
		<p class="about-description"><?php echo esc_html__( "To access our support forum, demo stacks, bonuses, you must be official buyer.<br />
	...
	<div class="rehub-registration-steps">
    	...
    	<div class="feature-section col three-col">
            <div class="col">
                ...
                <?php printf( '<a href="%s" class="button button-large button-primary rehub-large-button" target="_blank">%s</a>', 'https://www.youtube.com/channel/UCt3I0SO9yZ8ivyx4qKNCpJQ/videos', esc_html__( "Watch Videos", "rehub-theme" ) ); ?>
            </div>
            <div class="col">
