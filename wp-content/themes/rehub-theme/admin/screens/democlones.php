...
if($registeredlicense){
	$demos = array(
		"demo10"=> array(
			...
			"zip"=>"<a href='http://recomparedemo.wpsoul.net/wp-content/ai1wm-backups/recomparedemo.wpsoul.net-20180417-233828-394.wpress'>Download</a>",
			"name"=>"Recompare"
		),
		"demo11"=> array(
		...
		"demo7"=> array(
			...
			"zip"=>"<a href='http://rewisedemo.wpsoul.net/wp-content/ai1wm-backups/rewisedemo.wpsoul.net-20180809-174527-445.wpress'>Download</a>",
			"name"=>"Rewise"
		),	
		"demo8"=> array(
			"link"=>"http://redokan.wpsoul.net/",
			"zip"=>"<a href='http://redokandemo.wpsoul.net/wp-content/ai1wm-backups/redokandemo.wpsoul.net-20180418-233026-374.wpress'>Download</a>",
			"name"=>"Redokan"
		),
		"demo9"=> array(
			"link"=>"http://remarket.wpsoul.com/",
			"zip"=>"<a href='http://remarketdemo.wpsoul.net/wp-content/ai1wm-backups/remarketdemo.wpsoul.net-20180421-001509-913.wpress'>Download</a>",
			"name"=>"Remarket"
		),
		"demo2"=> array(
			"link"=>"http://repick.wpsoul.net/",
			"zip"=>"<a href='http://repickdemo.wpsoul.net/wp-content/ai1wm-backups/repickdemo.wpsoul.net-20180416-093830-651.wpress'>Download</a>",
			"name"=>"Repick"
		),	
		"demo3"=> array(
			"link"=>"http://rething.wpsoul.net/",
			"zip"=>"<a href='http://rethingdemo.wpsoul.net/wp-content/ai1wm-backups/rethingdemo.wpsoul.net-20171215-222140-372.wpress'>Download</a>",
			"name"=>"Rething"
		),
		"demo4"=> array(
			"link"=>"http://recash.wpsoul.net/",
			"zip"=>"<a href='http://recashdemo.wpsoul.net/wp-content/ai1wm-backups/recashdemo.wpsoul.net-20180415-111935-994.wpress'>Download</a>",
			"name"=>"Recash"
		),
		"demo5"=> array(
			"link"=>"http://redirect.wpsoul.net/",
			"zip"=>"<a href='http://redirectdemo.wpsoul.net/wp-content/ai1wm-backups/redirectdemo.wpsoul.net-20190106-141003-143.wpress'>Download</a>",
			"name"=>"Redirect"
		),
		"demo6"=> array(
			"link"=>"http://revendor.wpsoul.net/",
			"zip"=>"<a href='http://revendordemo.wpsoul.net/wp-content/ai1wm-backups/revendordemo.wpsoul.net-20180723-214830-190.wpress'>Download</a>",
			"name"=>"Revendor"
		),	
		"demo1"=> array(
			"link"=>"http://rehub.wpsoul.com/",
			"zip"=>"<a href='http://rehubcopy.wpsoul.net/wp-content/ai1wm-backups/rehubcopy.wpsoul.net-20180822-182843-426.wpress'>Download</a>",
			"name"=>"Rehub"
		),	
		"demo13"=> array(
