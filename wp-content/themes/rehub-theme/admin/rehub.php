...
if ( ! class_exists( 'Rehub_Admin' ) ) {
	...
	class Rehub_Admin{
		...
		function rehub_admin_scripts() {
            ...
            .column-elementor_library_type a:nth-child(2), .menu-icon-elementor_library .wp-first-item, .svx-license{display: none;} /*Elementor fix*/
