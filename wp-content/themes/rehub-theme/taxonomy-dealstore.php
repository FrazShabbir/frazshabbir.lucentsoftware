    ...
    <div class="rh-content-wrap clearfix">
        ...
        <div class="rh-mini-sidebar floatleft tabletblockdisplay mb20">
            <div class="text-center rh-cartbox woo-tax-logo mb20">       
                ...
                <?php             
                    if($brandurlurl){
                        echo '<a class="blockstyle mt15 rehub_main_btn width-100p wpsm-button" href="'.esc_url($brandurl).'" target="_blank" rel="nofollow" data-url="'.esc_url($brandurl).'" data-merchant="'.$tagname.'"><i class="far fa-external-link"></i> '.__('Go to shop', 'rehub-theme').'</a>';
                    }
                    if($brandshortdesc){
