...
vc_map( array(
    "name" => esc_html__('Column news block', 'rehub-theme'),
    "base" => "two_col_news",
    "icon" => "icon-t-c-news",
    "category" => esc_html__('Content modules', 'rehub-theme'),
    'description' => esc_html__('News in columns', 'rehub-theme'), 
    "params" => array(
        array(
            "type" => "textfield",
            "heading" => esc_html__('Offset for 2 column', 'rehub-theme'),
        ...
        array(
            "type" => "checkbox",
            "class" => "",
            "heading" => esc_html__('Show first post as compact?', 'rehub-theme'),
            "value" => array(__("Yes", "rehub-theme") => true ),
            "param_name" => "compact",         
        ), 
        array(
            "type" => "checkbox",
            "class" => "",
            "heading" => esc_html__('Disable second column?', 'rehub-theme'),
            "value" => array(__("Yes", "rehub-theme") => true ),
            "param_name" => "only_one",         
        ),        
        ...
        array(
            'type' => 'autocomplete',
            'heading' => esc_html__( 'Category first', 'rehub-theme' ),
        ...
        array(
            'type' => 'autocomplete',
            'heading' => esc_html__( 'Category exclude first', 'rehub-theme' ),
        ...
        array(
            'type' => 'autocomplete',
            'heading' => esc_html__( 'Tags first', 'rehub-theme' ),
        ...
        array(
            'type' => 'autocomplete',
            'heading' => esc_html__( 'Tags exclude first', 'rehub-theme' ),
        ...
        array(
            "type" => "dropdown",
            "heading" => esc_html__('Choose post formats first', 'rehub-theme'),
        ...
        array(
            'type' => 'autocomplete',
            'heading' => esc_html__( 'Category second', 'rehub-theme' ),
        ...
        array(
            'type' => 'autocomplete',
            'heading' => esc_html__( 'Category exclude second', 'rehub-theme' ),
        ...
        array(
            'type' => 'autocomplete',
            'heading' => esc_html__( 'Tags second', 'rehub-theme' ),
        ...
        array(
            'type' => 'autocomplete',
            'heading' => esc_html__( 'Tags exclude second', 'rehub-theme' ),
        ...
        array(
            "type" => "dropdown",
            "heading" => esc_html__('Choose post formats second', 'rehub-theme'),
