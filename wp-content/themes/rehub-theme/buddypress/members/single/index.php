			    		...
			    		echo '<div class="rh-bp-mycred-profile-points mb20 rehub-sec-color-bg rehub-sec-smooth"><div>';
			    			...
			    			if($cashpendingpoint){
								...
								if($mycashpendingpoint){
									echo '<div class="rh-bp-mycred-points-pr mt5 font70"><span>'.$mycashpendingpoint.'</span>'.esc_html($mycashpendinglabel).'<span class="font90 fontnormal ml5 mr5">('.esc_html__('Pending', 'rehub-theme').')</span></div>';
								}			    				
			    			}
			    			if($cashdeclinedpoint){
								...
								if($mycashdeclinedpoint){
									echo '<div class="rh-bp-mycred-points-pr mt5 font70"><span>'.$mycashdeclinedpoint.'</span>'.esc_html($mycashdeclinedlabel).'<span class="font90 fontnormal ml5 mr5">('.esc_html__('Declined', 'rehub-theme').')</span></div>';
								}			    				
			    			}			    			
			    		echo '</div></div>';						
					}								    			
